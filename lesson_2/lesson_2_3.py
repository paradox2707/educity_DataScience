...
def custom_heuristic(file_path):
    ...
    for passenger_index, passenger in df.iterrows():
        ...
        #
        passenger_id = passenger['PassengerId']
        if passenger['Sex'] == 'female' or (passenger['Age'] < 19 and passenger['Pclass'] < 3):
            predictions[passenger_id] = 1
        else:
            predictions[passenger_id] = 0
        #n.add(passenger["SibSp"])
        #n.add(passenger["Parch"])
        n.add(passenger["Cabin"])
...
if __name__ == '__main__':
    file_path = "C:\\titanic-data.csv"
    #file_path = "lesson_2titanic-data.csv"
